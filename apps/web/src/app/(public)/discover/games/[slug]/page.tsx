...
export default async function GamePage({ params }: GamePageProps) { const game = getGameBySlug((await params).slug); if (!game) notFound(); return <GameDetailPage game={game} />; }
